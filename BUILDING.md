...
1. Checkout the Signal-Android project source with the command:
        ...
        git clone https://github.com/signalblockchain/signalbc-android.git
...
6. Paste the URL for the Signal-Android project when prompted (https://github.com/signalblockchain/signalbc-android.git).
