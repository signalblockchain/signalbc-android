...
1. Checkout the Signal-Android project source with the command:
        ...
        git clone https://github.com/signalbc/Signal-Android.git
...
6. Paste the URL for the Signal-Android project when prompted (https://github.com/signalbc/Signal-Android.git).
